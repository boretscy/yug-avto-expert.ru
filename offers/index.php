...
LocalRedirect('/offers/programmy-ot-proizvoditeley/');
$APPLICATION->SetPageProperty("title", "Акции | Дилерский центр — Юг-Авто Эксперт");
...
if ( $_GET['brand'] ) {
    ...
    if ( $ob = $rs->GetNextElement() ) {
        ...
        $arFilterOffers['PROPERTY_BRAND'] = $ob->GetFields()['ID'];
    }
}
