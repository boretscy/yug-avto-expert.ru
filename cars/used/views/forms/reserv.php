        ...
        <div class="row">
            <div class="col-md-6 col-xl-4">
                <div class="position-relative b-radius-yaradius-25 b-yayellow b-border-2 p-4 h-100">
                    <div class="text-uppercase fw-bold h2" style="position:relative; z-index:10;"><noindex><?= $app->Conf()['Forms']['Reserv']['title'];?></noindex></div>
                    <div class="w-50 text-uppercase c-yadarkgray mt-4" style="position:relative; z-index:10;"><noindex><?= $app->Conf()['Forms']['Reserv']['text'];?></noindex></div>
                    <img class="form-img position-absolute" src="<?= $app->Conf()['baseUrl'];?>/assets/images/forms/reserv-car.jpg?2" />
                </div>
            </div>
                        ...
                        <div class="col-xl-5 mb-3">
                            <div class="form-group">
                                <a 
                                    ...
                                    rel=“nofollow”
                                    ><span><noindex>Подтвердить бронь</noindex></span></a>
                            </div>
                        </div>
                        <div class="col-12 mb-3">
