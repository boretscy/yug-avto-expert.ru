        ...
        <div class="row">
            <div class="col-md-6 col-xl-4">
                <div class="position-relative b-radius-yaradius-25 b-yayellow b-border-2 p-4 h-100">
                    <div class="text-uppercase fw-bold h2" style="position:relative; z-index:10;"><noindex><?= $app->Conf()['Forms']['Consult']['title'];?></noindex></div>
                    <div class="w-50 text-uppercase c-yadarkgray mt-4" style="position:relative; z-index:10;"><noindex><?= $app->Conf()['Forms']['Consult']['text'];?></noindex></div>
                    <img class="form-img position-absolute" src="<?= $app->Conf()['baseUrl'];?>/assets/images/forms/consult-car.jpg?3" />
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select class="form-select b-radius-yaradius-15 px-3" id="exampleSelect1">
                                ...
                                <option value="<?= $item['name'];?>"><noindex><?= $item['name'];?></noindex></option>
                                <?php } ?>
                            </select>
                            </div>
                        </div>
