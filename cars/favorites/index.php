...
$GLOBALS['META'] = $data['meta'] = json_decode( file_get_contents('https://apps.yug-avto.ru/API/get/cis/meta/used/?token=34b5ac8b71018c0bc7e5c050ed90b243&site=yug-avto-expert.ru&entity=used&brand=favorites'), true );
?>
...
<div id="YappsShowroom">
    ...
    <?php 
        ...
        include __DIR__.'/../used/views/favorites.php';
