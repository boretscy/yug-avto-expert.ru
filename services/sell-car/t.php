            ...
            <div class="row pt-3 list-services">
                <div class="col-md-4 mb-3">
                    <a 
                        ...
                        href="/services/sell-car/foreign/">
                        <img src="check-circle.svg" class="position-absolute" />
                ...
                <div class="col-md-4 mb-3">
                    <a 
                        class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100 text-decoration-none c-yablack c-h-yablack"
                        href="/services/sell-car/domestic/">
                        <img src="check-circle.svg" class="position-absolute" />
                        Выкуп отечественных автомобилей
                    </a>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100">
                        <img src="check-circle.svg" class="position-absolute" />
                        Выкуп авто юридических лиц и из корпоративных парков
                    </div>
                </div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп неисправных авто</div></div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп премиальных автомобилей</div></div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп легковых автомобилей</div></div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп аварийных автомобилей после ДТП</div></div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп автомобилей класса люкс</div></div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп коммерческих автомобилей</div></div>
                <div class="col-md-4 mb-3"><div class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100"><img src="check-circle.svg" class="position-absolute" />Выкуп авто с ограничениями и штрафами</div></div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <img class="mb-5" src="wallet.svg" />
                <p class="c-yadarkgray m-0 text-plus">Справедливую<br />цену</p>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <img class="mb-5" src="shield.svg" />
                <p class="c-yadarkgray m-0 text-plus">Юридическую<br />чистоту сделки</p>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <img class="mb-5" src="clock.svg" />
                <p class="c-yadarkgray m-0 text-plus">Деньги<br />в день сделки</p>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <img class="mb-5" src="like.svg" />
                <p class="c-yadarkgray m-0 text-plus">Сделка там,<br />где удобно вам</p>
            </div>
        </div>
    </div>
</div>
<div class="py-5 bg-yalightgray">
    <div class="container bordered b-radius-small">
        <div class="row mb-5">
            <div class="col-md-3 text-end ps-4 pb-5"><img class="w-100" src="steps-start.png" /></div>
            <div class="col-md">
                <div class="row py-5">
            ...
            <div class="col-md-3 text-end ps-5 d-none d-lg-block"><img class="w-100" src="steps-end.png" /></div>
        </div>
    </div>
    <div class="container">
        <div class="row my-5">
            <div class="col text-center">
                <a href="#FORM_BUYOUT_BUYOUT" class="bg-yayellow bg-h-yayellow c-yablack c-h-yablack text-uppercase text-decoration-none py-3 px-5 b-radius-small">Связаться</a>
            </div>
        </div>
    </div>
</div>
