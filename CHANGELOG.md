...
- **Адаптация плашки Cookie (`.cookie`) для мобильных устройств:**
  ...
  - В шаблоне футера `footer/template.php` класс кнопки согласия заменен с `but-lg` на компактные паддинги `py-2 px-4`.
  - Сброшен кэш компонентов Битрикса и OPcache.
