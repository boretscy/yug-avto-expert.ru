...
<?php 
    ...
    $cacheTime = 300;
    $cacheId = 'promo_buyout_rostov_vehicles';
    ...
    if ($cache->initCache($cacheTime, $cacheId, $cacheDir)) {
        ...
        $raw = @file_get_contents('https://apps.yug-avto.ru/API/get/cis/random/used/?token=34b5ac8b71018c0bc7e5c050ed90b243', false, $ctx);
    ...
    $GLOBALS['CITY'] = 'Ростов-на-Дону';
    $GLOBALS['MAP_CENTER'] = [47.215419, 39.612874];
...
<div class="container my-5" data-scroll="buyoutBlock">
    <div class="row">
        <div class="col-md-6 col-lg-3">
            <img class="w-100" src="/promo/buyout/rostov/car2.png" />
        </div>
        <div class="col">
            ...
            <div class="col-md-4 mb-3 d-md-none">
                    <a 
                        ...
                        <img src="/promo/buyout/rostov/check-yellow.svg" class="position-absolute" />
                ...
                <div class="col-md-4 mb-3">
                    <a 
                        class="p-2 ps-5 b-radius-small bg-yalightgray position-relative d-flex align-items-center h-100 text-decoration-none c-yablack c-h-yablack">
                        <img src="/promo/buyout/rostov/check-circle.svg" class="position-absolute" />
    ...
    <div class="row">
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <div class="row">
                    <div class="col-4 col-md-12 mb-md-5"><img src="/promo/buyout/rostov/wallet.svg" /></div>
        ...
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <div class="row">
                    <div class="col-4 col-md-12 mb-md-5"><img src="/promo/buyout/rostov/shield.svg" /></div>
        ...
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <div class="row">
                    <div class="col-4 col-md-12 mb-md-5"><img src="/promo/buyout/rostov/clock.svg" /></div>
        ...
        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
            <div class="b-radius-small b-yagray p-4">
                <div class="row">
                    <div class="col-4 col-md-12 mb-md-5"><img src="/promo/buyout/rostov/like.svg" /></div>
...
<div class="py-5 bg-yalightgray" data-scroll="sellBlock">
    <div class="container bordered b-radius-small">
        <div class="row mb-5">
            <div class="col-md-3 text-end ps-4 pb-5"><img class="w-100" src="/promo/buyout/rostov/steps-start.png" /></div>
            <div class="col-md">
                <div class="row py-5">
            ...
            <!-- <div class="col-md-3 text-end ps-5 d-none d-lg-block"><img class="w-100" src="/promo/buyout/rostov/car4.png" /></div> -->
        </div>
    </div>
    <div class="container">
        <div class="row my-5">
...
<?php $arFilterDealerships = ['PROPERTY_TAG_VALUE' => ['Выкуп','Выездной выкуп'],'PROPERTY_CITY_VALUE' => ['Ростов-на-Дону']];?>
