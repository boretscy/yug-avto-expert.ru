...
<!--noindex-->
<div class="position-relative py-5 bg-yalightgray">
    <div class="container">
		<div class="row p-3 bg-yalightyellow c-yablack text-center b-radius-small mb-3 mt-5" style="display: none" role="success">
			<div class="col">
        ...
        <form class="row bg-yawhite p-2 p-md-3 b-radius-yaradius-50 mx-3 mx-mb-0" id="form-block-semiblue" data-sid="<?= $arResult['arForm']['SID'];?>">
