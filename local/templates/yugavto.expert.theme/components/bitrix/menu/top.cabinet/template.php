        ...
        <div class="row align-items-center">
            ...
            <div class="col-2 text-end">
                <a href="#" class="me-2 text-decoration-none">
                    <img src="<?= $templateFolder;?>/images/messages.svg" />
                </a>
            ...
            <div class="col-3 d-flex justify-content-end">
                <a href="/cabinet/user/" class="me-4 text-decoration-none d-flex align-items-center">
                    <img src="<?= $templateFolder;?>/images/user.svg" class="me-2" />
                    <span><?= (($USER->GetFirstName())?:'Без имени');?></span>
                </a>
