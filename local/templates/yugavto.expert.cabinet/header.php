...
<?php 
    ...
    if ( $cab::checkAuth() ) {
        $user = $cab::getCabUserBySSID( $cab::getAUthSSID() );
        $user['INFO'] = $cab::getUserByGUID($user['PROPERTY_GUID_VALUE']);
        // $user['INFO']['Status'] = false;
        $GLOBALS['CABINET_USER'] = $user;
    }
?>
<!doctype html>
<html lang="ru">
    <head>
        ...
        <?php 
            ...
            $Asset->addCss(SITE_TEMPLATE_PATH.'/assets/css/lib/chartist.min.css');
            ...
            $Asset->addJs(SITE_TEMPLATE_PATH.'/assets/js/lib/chartist.min.js');
