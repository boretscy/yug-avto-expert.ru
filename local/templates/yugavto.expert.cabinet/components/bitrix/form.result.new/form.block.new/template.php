				...
				<div class="col-12 mt-4 form-agree c-yamiddlegray">
					<div class="form-check">
						...
						<label class="form-check-label text-minus-minus" for="AGRYY_<?= $arResult['arForm']['ID'];?>">
							Даю согласие на обработку своих <a href="/about/personal-data-permission.php" target="_blank" class="c-yalightblack c-h-yalightblack">персональных данных</a> и соглашаюсь с <a href="/about/personal-data-policy.php" target="_blank" class="c-yalightblack c-h-yalightblack">политикой обработки персональных данных</a>
						</label>
					</div>
				</div>
