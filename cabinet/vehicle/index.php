...
<?php
    ...
    if ( $vehicle ) {
        $data = json_decode( YApp::httpGet('https://apps.yug-avto.ru/API/get/cis/vehicle/used/'.$vehicle.'/?token=ef6541490c8bb9d481d37020b6a1953e&site=yug-avto-expert.ru'), true );
    }
?>
